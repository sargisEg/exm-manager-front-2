...
export const DeleteSubgroupModal = ({ open, setOpenModal, onRemove, idToRemove }: { open: boolean; setOpenModal: (val: boolean) => void; onRemove: (subgroupId : string) => void; idToRemove: string}) => {
                    ...
                    >
                        <DialogPanel className="w-full max-w-md rounded-2xl bg-white p-6 shadow-xl">
                            ...
                            <Description className="mt-2 text-sm text-gray-900">
                                Are you sure that you want to delete a subgroup?
                            </Description>
