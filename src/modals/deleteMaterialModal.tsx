...
export const DeleteMaterialModal = ({ open, setOpenModal, onRemove, idToRemove }: { open: boolean; setOpenModal: (val: boolean) => void; onRemove: (id : string) => void; idToRemove: string}) => {
