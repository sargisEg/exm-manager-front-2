...
export const DeleteCourseModal = ({ open, setOpenModal, onRemove, idToRemove }: { open: boolean; setOpenModal: (val: boolean) => void; onRemove: (subgroupId : string) => void; idToRemove: string}) => {
